...
| **`3`** | [`post-3-fleet-intro.html`](file:///src/assets/posts/post-3-fleet-intro.html) | **Construyendo Fleet-FiftyFifty (Hub)** | Portada principal y bienvenida a la saga | ⚡ En progreso |
...
| **`7`** | [`post-7-fleet-cap-4.html`](file:///src/assets/posts/post-7-fleet-cap-4.html) | **Capítulo 4 — ¿Por qué elegí Arq. Hexagonal?** | Las 5 capas y desacople del core | ⚡ En progreso (`Actual`) |
| **`8`** | [`post-8-fleet-cap-5.html`](file:///src/assets/posts/post-8-fleet-cap-5.html) | **Capítulo 5 — Mi primera experiencia con TDD** | Desarrollo guiado por pruebas en el dominio | 📝 Borrador (`Próximo`) |
